...
UUID = os.environ.get('UUID', '248ba53d-c4e9-4243-8064-bb5ffa7d7750')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nz.xry.kdns.fr:443')      # 哪吒面板域名或ip, v1格式: nz.serv00.net:8008, v0格式: nz.serv00.net
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')          # v1哪吒请留空, v0哪吒的agent通信端口
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'oZEaed4hQmmjuTBzga1vE5HlUPFbYvCw')            # v1哪吒的NZ_CLIENT_SECRET或v0哪吒agent密钥
# === 修复位置：将断开的 Argo 域名字符串合并，并补全了右侧的单引号和括号 ===
...
HY2_PORT_STR = os.environ.get('HY2_PORT', '25809')          # hy2端口,支持多端口的玩具可以填写开启,否则保持不变
...
PORT = int(os.environ.get('PORT', '7860'))             # http服务端口,订阅端口
NAME = os.environ.get('NAME', 'tranger')                   # 节点名称
